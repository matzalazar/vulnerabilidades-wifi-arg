...
El uso de contraseñas predictibles constituye una **falla de seguridad estructural**. Las operadoras como Fibertel deberían abandonar este esquema de generación y obligar a la configuración personalizada desde el primer uso.
